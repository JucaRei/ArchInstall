...
# Universe repo optimus-manager-dinit
...
ln -s /etc/dinit.d/tlp /etc/dinit.d/boot.d/
...
ln -s /etc/dinit.d/statd /etc/dinit.d/boot.d/
...
pacman -S zramen zramen-dinit --noconfirm

# sed -i "s/#export ZRAM_COMP_ALGORITHM='lz4'/export ZRAM_COMP_ALGORITHM='zstd'/g" /etc/dinit/sv/zramen/conf
# sed -i 's/#export ZRAM_SIZE=25/export ZRAM_SIZE=100/g' /etc/dinit/sv/zramen/conf
