...
apt update && apt install debootstrap lsb-release wget arch-install-scripts -y
...
chroot /mnt sh -c 'echo "root:2221091" | chpasswd -c SHA512'
chroot /mnt useradd vitor -m -c "Reinaldo P JR" -s /bin/bash
chroot /mnt sh -c 'echo "vitor:2221091" | chpasswd -c SHA512'
chroot /mnt usermod -aG floppy,audio,sudo,video,systemd-journal,kvm,lp,cdrom,netdev,input,libvirt,kvm vitor
chroot /mnt usermod -aG sudo vitor
...
touch /mnt/home/vitor/.xsessionrc
cat << EOF > /mnt/home/vitor/.xsessionrc
xrandr --setprovideroutputsource 1 0
EOF

chroot /mnt chmod +x /home/vitor/.xsessionrc
chroot /mnt chown -R vitor:vitor /home/vitor/.xsessionrc
