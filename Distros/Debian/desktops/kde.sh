...
chroot /mnt apt install --no-install-recommends -y kde-config-plymouth kde-config-screenlocker plasma-discover \
...
plasma-disks plasma-firewall plasma-wallpapers-addons mpv kdiskmark
