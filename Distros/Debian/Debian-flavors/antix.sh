...
cp --reflink -a /mnt/{bin,boot,dev,etc,home,lib,lib32,lib64,libx32,media,mnt,opt,proc,root,run,sbin,srv,sys,tmp,usr,var} /mnt/@

cp -ax --reflink=always /mnt/home /mnt/@home
cp -ax --reflink=always /mnt/var/log /mnt/@var_log

btrfs subvolume snapshot /mnt/{bin,boot,dev,etc,home,lib,lib32,lib64,libx32,media,mnt,opt,proc,root,run,sbin,srv,sys,tmp,usr,var} /mnt/@
btrfs subvolume snapshot /mnt/{bin,boot,dev,etc,home,lib,lib32,lib64,libx32,media,mnt,opt,proc,root,run,sbin,srv,sys,tmp,usr,var} /mnt/@
btrfs subvolume snapshot /mnt/{bin,boot,dev,etc,home,lib,lib32,lib64,libx32,media,mnt,opt,proc,root,run,sbin,srv,sys,tmp,usr,var} /mnt/@
...
876b0c66-f115-458f-bb6b-e7b7113f8497
