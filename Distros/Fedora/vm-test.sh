...
# ⚙️ Btrfs options
BTRFS_OPTS="nodatacow,nodatasum,noatime,ssd,compress-force=zstd:15,space_cache=v2,nodatacow,commit=120,discard=async"
BTRFS_OPTS_HOME="nodatacow,nodatasum,noatime,ssd,compress-force=zstd:8,space_cache=v2,nodatacow,commit=120,discard=async"
