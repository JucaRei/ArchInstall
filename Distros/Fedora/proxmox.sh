...
mkdir -pv /mnt/{boot,home,.snapshots,var/{log,cache/dnf,lib/libvirt/images}}
...
mount -o $BTRFS_OPTS,subvol=@dnf /dev/disk/by-label/Fedora /mnt/var/cache/dnf
