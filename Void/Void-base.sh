...
chroot /mnt XBPS_ARCH="x86_64" xbps-install -y base-system zstd linux-lts linux-lts-headers neovim dbus grub-x86_64-efi tlp intel-ucode zsh nvidia nvidia-libs-32bit alsa-utils vim git wget curl efibootmgr btrfs-progs nano ntfs-3g mtools dosfstools grub-x86_64-efi elogind vsv vpm polkit chrony neofetch duf lua bat glow bluez bluez-alsa xdg-user-dirs xdg-utils
