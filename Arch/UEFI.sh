...
sudo sed -i 's/GRUB_COLOR_NORMAL="red/black"/g'
# sudo sed -i 's/GRUB_COLOR_HIGHLIGHT="yellow/black"/g'
# sudo sed -i 's/#GRUB_DISABLE_OS_PROBER=true/GRUB_DISABLE_OS_PROBER=false/g'
# OLDPC don`t need it
