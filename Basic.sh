...
sudo pacman -S xorg sddm plasma konsole wget curl dolphin ark kate kwrite kcalc spectacle krunner partitionmanager firefox vlc papirus-icon-theme materia-kde visual-studio-code-git zsh pacman-contrib snapper snapper-gui-git snap-pac-grub rsync 
